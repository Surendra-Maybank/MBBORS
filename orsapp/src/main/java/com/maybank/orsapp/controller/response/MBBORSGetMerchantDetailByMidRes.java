...
public class MBBORSGetMerchantDetailByMidRes extends MBBORSCommonRes {
	...
	private List<TerminalDTO> terminalId;
	...
	public List<TerminalDTO> getTerminalId() {
		return terminalId;
	}

	public void setTerminalId(List<TerminalDTO> terminalId) {
