...
//        String dateTimeStamp = "20201125T014119Z";
        ...
        System.out.println("canonicalizedHeaderNames : ".concat(canonicalizedHeaderNames));
        String canonicalizedHeaders = getCanonicalizedHeaderString(headers);
        System.out.println("canonicalizedHeaders : ".concat(canonicalizedHeaders));
        
        // if any query string parameters have been supplied, canonicalize them
        String canonicalizedQueryParameters = getCanonicalizedQueryString(queryParameters);
        System.out.println("canonicalizedQueryParameters : ".compareTo(canonicalizedQueryParameters));
        // canonicalize the various components of the request
        String canonicalRequest = getCanonicalRequest(endpointUrl, httpMethod,
                canonicalizedQueryParameters, canonicalizedHeaderNames,
                canonicalizedHeaders, bodyHash);
        System.out.println("--------- Canonical request --------");
        System.out.println("canonicalRequest : ".concat(canonicalRequest));
        System.out.println("------------------------------------");
...
//        String stringToSign = getStringToSign(SCHEME, ALGORITHM, dateTimeStamp, scope, canonicalRequest);
        ...
        byte[] kSecret = (SCHEME.concat(awsSecretKey)).getBytes();
